...
CREATE TABLESPACE global_ts WITH (replica_placement='{"num_replicas": 1, "placement_blocks": [{"cloud":"local","region":"usa","zone":"usa-a","min_num_replicas":1}]}');
